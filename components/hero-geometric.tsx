          ...
          >
            <div className="max-w-2xl mx-auto mb-8">
              <div className="relative">
                ...
                <div className="relative bg-white/[0.03] backdrop-blur-sm border border-white/[0.08] rounded-2xl p-2">
                  <div className="flex flex-col sm:flex-row gap-2">
                    <div className="flex-1 relative">
                      <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white/40 w-5 h-5" />
                      <Input
                        placeholder="What do you need to rent?"
                        className="pl-12 h-14 bg-transparent border-0 text-white placeholder:text-white/40 text-lg focus:ring-0 focus:outline-none"
                      />
                    </div>
                    <Link href="/browse">
                      <Button
