                ...
                >
                  <div className="grid gap-1.5">
                    ...
                    <span className="font-mono font-medium tabular-nums text-foreground">
                      {itemFormatter ? itemFormatter(item.value, item.name, item, index, item.payload) : item.value}
                    </span>
                  </div>
                </div>
              </div>
...
export { ChartContainer, ChartTooltip, ChartTooltipContent, ChartLegend, ChartLegendContent, type ChartConfig }
